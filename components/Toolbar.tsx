...
export default function Toolbar() {
  ...
  return (
    <div className="flex flex-col gap-2 px-4 py-3">
      <button
        className="w-full py-1.5 text-[13px] font-medium rounded-md bg-accent text-zinc-950 hover:brightness-110 transition"
      ...
      <div className="flex gap-2">
        <button
          className="flex-1 py-1.5 text-[13px] font-medium rounded-md bg-zinc-800 text-zinc-300 hover:bg-zinc-700 transition"
